			...
			<div class="showcase__items">
				<a
					:class="[
						...
						{
							'showcase__items__item--active--from-left':
								index === showcaseItemCurrent,
						},
						{
							'showcase__items__item--inactive--to-left':
								index === !showcaseItemCurrent,
						},
					]"
				...
				>
					<g-image
						...
						:src="
							require(`~/assets/img/${showcaseItemType}-${item.node.img}.jpg`)
						"
					/>
				</a>
			</div>
...
export default {
	...
	methods: {
		decrementShowcaseItemCurrent() {
			if (this.showcaseItemCurrent === 0)
				return (this.showcaseItemCurrent = this.showcaseItems.length - 1);
		...
		incrementShowcaseItemCurrent() {
			if (this.showcaseItemCurrent === this.showcaseItems.length - 1)
				return (this.showcaseItemCurrent = 0);
			return (this.showcaseItemCurrent += 1);
		},
	},
	props: [
